...
dice_frm = sg.Frame('Common Dice',
                    [[col_d4, col_d6, col_d8, col_d10, col_d12, col_d20]])
...
drop_layout = [[
    sg.Combo(['Do not drop', 'Drop lowest', 'Drop highest'],
             'Do not drop',
             size=11,
             key='-DROP_SELECT-',
             readonly=True,
...
credits_layout = [[sg.Text('Made with <3 by Aerie')],
...
layout = [[
    sg.Column(
        col_left, vertical_alignment='top', element_justification='center'),
